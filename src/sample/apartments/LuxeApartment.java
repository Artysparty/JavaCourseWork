...
public class LuxeApartment extends AbstractApartment implements Payment {

    public LuxeApartment(int payment, int barSize, int numberOfRooms, int numberOfBeds) {
    ...
    @Override
    public int calc() {
        return getNumberOfRooms() * getPayment() + getBarSize() * 10;
    }
}
